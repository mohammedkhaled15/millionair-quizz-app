...
const Winner = ({ waitSound, stopWaiting }) => {
  ...
  return (
    <div className='flex flex-col h-screen self-center items-center'>
      <EmojiEventsIcon style={{ color: "yellow", fontSize: "120px" }} className='winner animate-pulse duration-500 ease-in-out' />
